...
export const roomPackages = [
  {
    ...
    price: 999,
    currency: 'INR',
    description: 'A quick retreat to rest, refresh, and reset between adventures in our Livzo JAH Room.',
  },
  {
    id: '6hr',
    duration: '6 Hours',
    ...
    price: 1499,
    currency: 'INR',
    description: 'Half-day comfort in our Livzo JAH Room. Settle in, unwind, enjoy the stillness.',
  },
  {
    id: '12hr',
    duration: '12 Hours',
    ...
    price: 1999,
    currency: 'INR',
    description: 'A full overnight stay in our Livzo JAH Room. Fall asleep to nature, wake up to birdsong.',
  },
];
...
export const campingExperiences = [
  {
    ...
    icon: 'tent',
    includes: ['Premium tent setup', 'Sleeping bags & mats'],
    price: 799,
  ...
  },
  {
    id: 'camping-meals',
    name: 'Camping + Meals',
    tagline: 'Stay and dine in nature',
    icon: 'flame',
    includes: ['Premium tent setup', '3 Times Food / Meals'],
    price: 1499,
    unit: 'per person / night',
  ...
  },
  {
    id: 'camping-full',
    name: 'The Full Camp',
    tagline: 'The complete outdoor experience',
    icon: 'sparkles',
    includes: ['Premium tent setup', '3 Times Food / Meals', 'Bonfire & Stargazing'],
    price: 1999,
    unit: 'per person / night',
...
export const groupPackages = [
  { id: 'mini', name: 'LIVZO Mini', people: 10, pricePerPerson: 2500, note: 'Personal Party arrangement' },
  { id: 'crew', name: 'LIVZO Crew', people: 15, pricePerPerson: 2400, note: 'Bonfire + 1 time boating' },
  { id: 'squad', name: 'LIVZO Squad', people: 20, pricePerPerson: 2300, note: 'Bonfire + 1 time boating' },
  { id: 'tribe', name: 'LIVZO Tribe', people: 25, pricePerPerson: 2200 },
  { id: 'group', name: 'LIVZO Group', people: 30, pricePerPerson: 2100 },
  { id: 'collective', name: 'LIVZO Collective', people: 40, pricePerPerson: 2000 },
  { id: 'fest', name: 'LIVZO Fest', people: 50, pricePerPerson: 1900 },
  { id: 'mega', name: 'LIVZO Mega', people: 75, pricePerPerson: 1800 },
  { id: 'event', name: 'LIVZO Event', people: 100, pricePerPerson: 1700 },
];

export const familyPackage = {
  id: 'normal-package',
  name: 'LIVZO Classic',
  tagline: 'The essential LIVZO escape.',
  price: 2199,
  currency: 'INR',
  unit: 'per person',
  includes: [
    { item: '3-Time Food', description: 'Breakfast, lunch & dinner' },
    { item: 'Room Stay', description: 'Comfortable accommodation' },
    { item: 'Evening Tea', description: 'Chai & light snacks' },
    { item: 'Pool Access', description: 'Swimming pool entry' },
    { item: 'Drinking Water', description: 'Purified water provided' },
